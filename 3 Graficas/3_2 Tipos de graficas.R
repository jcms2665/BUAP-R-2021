...
# Github:     https://github.com/jcms2665/BUAP-R-2021
# Notas:       
...
#Cuado aparece error, checar la ruta
#Para cargar una base propia, cambiar: nombre, extension (.dta/.sav), nombre del archivo
    ...
    # El signo de $ me indica pertenencia
    ...
    # Cuando tengo un = significa asignación
    # Cuando tengo == significa comparacion
    
    # 3.2 Etiquetar datos
        
    # PB1=SEXO
    # Codigos: 1=Hombre, 2=Mujer
    # La función "factor" sirve para etiquetar y requiere 3 argumentos:
    # 1. Nombre de la variable, 2. codigo, 3. etiqueta
    
    ocupados$PB1 = factor(ocupados$PB1,levels = c(1,2),labels = c("Hombre","Mujer"))
    # Si corro 2 veces la etiqueta, borra el contenido de la variable
    # Si se borra el contenido, hay que cargar nuevamente
...
#4. Graficas (ggplot)
    ...
    # 2da capa tiene el tipo de gráfica
    ...
    # g2 es la primera capa (definición de base de datos y variables)
    ...
    g4+geom_histogram(binwidth = 5)+
      ggtitle("Edad")+              # position ajusta la posicion de las barras
      xlab("Edad")+
      ylab("Personas")
    ...
    #4.4 Una variable continua y una discreta
    # aes me sirve para indicar las variables/colores
    # PB2 es v. continua
    # PB1 es v. discreta
