...
setwd("D:/OneDrive - El Colegio de México A.C/5. Proyectos/2021/46. SIGMA/3 R-intro/Versión SIGMA161/Introducción a R/4 Mapas/4_2 Datos")
      covid=read.csv("Casos_Diarios_Estado_Nacional_Confirmados_20210809.csv")
      
            #4.1.1 Crear la variable SUMA
            # De la base covid, crea una nueva variable (uso la función "mutate")
            # que se llama SUMA.
            # La v. SUMA = de la v.4 a la v. 542
      ...
      #  ii. Si queremos número, debir ir =0
      #  iii. Si queremos texto, debe ir =""
      #  v. La nueva variable está vacía.
      covid$rango=""
      covid$rango[covid$SUMA<=40729]<-"Bajo"
      covid$rango[covid$SUMA>40729 & covid$SUMA<=67858]<-"Medio"
      covid$rango[covid$SUMA>67858]<-"Alto"
      
      #4.5 De la base covid solo nos quedamos con cve_ent, rango y SUMA
      ...
      setwd("D:/OneDrive - El Colegio de México A.C/5. Proyectos/2021/46. SIGMA/3 R-intro/Versión SIGMA161/Introducción a R/4 Mapas/4_1 Shape")
